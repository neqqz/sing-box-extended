...
replace github.com/sagernet/quic-go => github.com/neqqz/quic-go v0.0.0-20260917050314-dd36e1cb972f

replace golang.org/x/net => github.com/neqqz/net v0.0.0-20260916050415-28283e434acd
