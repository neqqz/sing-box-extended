...
replace github.com/sagernet/quic-go => github.com/neqqz/quic-go v0.0.0-20260810204130-a1d43c5b91c2

replace golang.org/x/net => github.com/neqqz/net v0.0.0-20260820113606-b8fcd5bc5061
